  ...
  return (
    <div className="grid grid-cols-12 gap-6 text-purple">
      <div className="col-span-2 bg-white rounded-lg py-4 px-6 grid place-content-center">
        <h3 className="text-center text-title font-black uppercase">
          <span className="block">{day}</span>
          <span className="block text-[38px]">{month}</span>
        </h3>
      </div>
      <div className="col-span-10 bg-white rounded-lg p-6 grid grid-cols-12 items-center gap-6">
        ...
        <div className="col-span-3">
          <CustomButton block>Conoce más</CustomButton>
        </div>
      </div>
    </div>
  )
